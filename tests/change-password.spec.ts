...
test.beforeEach('login successfuly', async ({page})=>{
  ...
  await login.loginWithEmailPassword('testaccount111@gmail.com','Test123!')
...
test.describe('Happy Case : change password successfuly ',  ()=>{
  test('TC_CP_1 : change password successfully ', async ({page})=>{
    await changepassword.ChangePasswordSuccessfullyAndResetPasswordAndVerifyNotification('Test123!','NewPass@123')
  })

  // fail testcase : password just limited 30 character 
  test.skip('TC_CP_11 : Verify that user can change password with a 256-character long password.', async ({})=>{
    await changepassword.ChangePasswordSuccessfullyAndResetPasswordAndVerifyNotification('Test123!','Abc123!@#Abc123!@#Abc123!@#Abc123!@#Abc123!@#Abc123!@#Abc123!@#Abc123!@#Abc123!@#Abc123!@#Abc123!@#Abc123!@#Abc123!@#Abc123!@#Abc123!@#Abc123!@#')
  })
...
test.describe('Negative case:', ()=>{
  test('TC_CP_02 : Verify that change password failed if the new password is too short.', async ({})=>{
  ...
  test('TC_CP_03 : Verify that change password failed if the new password does not contain an uppercase letter.', async ({})=>{
  await changepassword.enterCurentPassword('Test123!')
  ...
  test('TC_CP_04 : Verify that change password failed if the new password does not contain a lowercase letter.', async ({})=>{
  await changepassword.enterCurentPassword('Test123!')
  await changepassword.enterNewPassword('NEWPASS@123')
  await changepassword.enterConfirmPassword('NEWPASS@123')
  await changepassword.clickOnSaveButton()
 ...
 test('TC_CP_05 : Verify that change password failed if the new password does not contain a number.', async ({})=>{
  await changepassword.enterCurentPassword('Test123!')
  ...
  test('TC_CP_06 : Verify that change password failed if the new password does not contain a special character.', async ({})=>{
  await changepassword.enterCurentPassword('Test123!')
  ...
  test('TC_CP_07 : Verify that change password failed if confirmation does not match the new password.', async ({})=>{
  await changepassword.enterCurentPassword('Test123!')
  await changepassword.enterNewPassword('NewPass@123')
 ...
 // Fail test -- password change when enter wrong old password
  test.skip('TC_CP_08 : Verify that change password failed if the current password is incorrect.', async ({})=>{
  ...
  test('TC_CP_11 : Verify that change password failed if the new password exceeds 256 characters.', async ({})=>{
  await changepassword.enterCurentPassword('Test123!')
  ...
  test.skip('TC_CP_12 : Verify that change password failed if the new password is the same as the old password.', async ({})=>{
  await changepassword.enterCurentPassword('Test123!')
  await changepassword.enterNewPassword('NewPass@123')
  await changepassword.enterConfirmPassword('NewPass@123')
  await changepassword.clickOnSaveButton()
  ...
  test('TC_CP_13 : Verify that change password failed if the new password contains invalid characters.', async ({})=>{
  await changepassword.enterCurentPassword('Test123!')
  ...
  test.skip('TC_CP_14 : Verify that change password failed if the new password starts with a space.', async ({})=>{
  await changepassword.enterCurentPassword('Test123!')
  ...
  test.skip('TC_CP_15 : Verify that change password failed if the new password ends with a space.', async ({})=>{
  await changepassword.enterCurentPassword('Test123!')
  await changepassword.enterNewPassword('Pass@123 ')
  await changepassword.enterConfirmPassword('Pass@123 ')
  await changepassword.clickOnSaveButton()
  ...
  test.skip('TC_CP_16 : Verify that change password failed if the new password contains multiple spaces.', async ({})=>{
  await changepassword.enterCurentPassword('Test123!')
  await changepassword.enterNewPassword('Pass @ 123')
  await changepassword.enterConfirmPassword('Pass @ 123')
  await changepassword.clickOnSaveButton()
  ...
  test('TC_CP_17 : Verify that change password failed if empty/blank old password.', async ({})=>{
  ...
  test('TC_CP_18 : Verify that change password failed if empty/blank new password.', async ({})=>{
  await changepassword.enterCurentPassword('Test123!')
  ...
  test('TC_CP_19 : Verify that change password failed if empty/blank confirm password.', async ({})=>{
  await changepassword.enterCurentPassword('Test123!')
  await changepassword.enterNewPassword('Pass@123')
  ...
  test('TC_CP_20 : Verify that change password failed if new password contains Unicode hoặc emoji.', async ({})=>{
  await changepassword.enterCurentPassword('Test123!')
  await changepassword.enterNewPassword('NewPass@123😊')
  await changepassword.enterConfirmPassword('NewPass@123😊')
  await changepassword.clickOnSaveButton()
